  ...
  return (
    <div className="icu-container">
        ...
        <ul className="nav-links">
          ...
          <li className="nav-dropdown">
            ...
            <ul className="nav-dropdown-menu">
              <li><Link to="/booking/icu" className="active">ICU</Link></li>
      ...
      <div className="icu-title-section">
        <h2>ICU Bed Booking</h2>
        <p>Find and book ICU beds across hospitals in Dhaka</p>
      </div>
        ...
        <div className="modal-overlay" onClick={() => setShowBookingModal(false)}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            <div className="modal-header">
              <h3>Book ICU at {selectedHospital.hospital_name}</h3>
        ...
        <div className="modal-overlay" onClick={() => setShowWaitlistModal(false)}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="waitlist-info">
              <p>No ICU beds are currently available. Join the waitlist and we'll notify you when a bed becomes available.</p>
            </div>
        ...
        <div className="modal-overlay" onClick={() => setShowSuccessPopup(false)}>
          <div className="modal-content success-popup" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="success-popup-body">
              <p className="success-message">Your ICU bed has been successfully booked.</p>
